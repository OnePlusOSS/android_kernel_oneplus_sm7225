...
int bq2597x_hardware_init_pd_qc(void) {
	...
	ret = bq2597x_write_byte(bq, 0x06, 0x46);
...
int bq2597x_hardware_init_swarp(void) {
	struct bq2597x *bq = charger_ic;
	int ret;
	if (!charger_ic) {
		bq_err("bq2597x_hardware_init Failed: charger_ic  is null\r\n")
	...
	ret = bq2597x_write_byte(bq, 0x0f, 0x02);
	ret = bq2597x_write_byte(bq, 0x00, 0x78);
	ret = bq2597x_write_byte(bq, 0x01, 0xc6);
	ret = bq2597x_write_byte(bq, 0x02, 0xda);
	ret = bq2597x_write_byte(bq, 0x03, 0xd1);
	ret = bq2597x_write_byte(bq, 0x04, 0xa8);
	ret = bq2597x_write_byte(bq, 0x05, 0x48);
	ret = bq2597x_write_byte(bq, 0x06, 0x5a);
	ret = bq2597x_write_byte(bq, 0x07, 0xda);
	ret = bq2597x_write_byte(bq, 0x08, 0x13);
	ret = bq2597x_write_byte(bq, 0x09, 0x9c);
	ret = bq2597x_write_byte(bq, 0x0a, 0x68);
	ret = bq2597x_write_byte(bq, 0x0b, 0xc8);
	ret = bq2597x_write_byte(bq, 0x0c, 0x66);
	ret = bq2597x_write_byte(bq, 0x0d, 0x66);
	...
	ret = bq2597x_write_byte(bq, 0x24, 0x44);
	//bq2597x_dump_reg();
	pr_info("[OPLUS_CHG][bq2597x_hardware_init_swarp]\r\n");

	return 0;
}

int bq2597x_hardware_init_normal_warp(void) {
	struct bq2597x *bq = charger_ic;
	int ret;
	if (!charger_ic) {
		bq_err("bq2597x_hardware_init Failed: charger_ic  is null\r\n");
	...
	ret = bq2597x_write_byte(bq, 0x04, 0xa8);
	ret = bq2597x_write_byte(bq, 0x05, 0x48);
	ret = bq2597x_write_byte(bq, 0x06, 0x64);
	ret = bq2597x_write_byte(bq, 0x07, 0xe4);
	ret = bq2597x_write_byte(bq, 0x08, 0x17);
	ret = bq2597x_write_byte(bq, 0x09, 0x94);
	ret = bq2597x_write_byte(bq, 0x0a, 0x68);
	ret = bq2597x_write_byte(bq, 0x0b, 0xc8);
	ret = bq2597x_write_byte(bq, 0x0c, 0x66);
	ret = bq2597x_write_byte(bq, 0x0d, 0x66);
	...
	ret = bq2597x_write_byte(bq, 0x24, 0x44);
	//bq2597x_dump_reg();
	pr_info("[OPLUS_CHG][bq2597x_hardware_init_normal_warp]\r\n");
...
extern int bq2597x_hardware_init_swarp(void);
extern int bq2597x_hardware_init_normal_warp(void);
extern int oplus_bq2597x_reset_cp(void);

struct oplus_warp_cp oplus_rkbq2597x_ops = {
		.hardware_init_cp =	bq2597x_hardware_init,
		.warp_enable_cp = voov_enable_bq2597x,
		.warp_disable_cp = voov_disable_bq2597x,
		.cp_dump_reg = bq2597x_dump_status_reg,
		.cp_hardware_init_swarp = bq2597x_hardware_init_swarp,
		.cp_hardware_init_warp = bq2597x_hardware_init_normal_warp,
...
static int bq2597x_charger_probe(struct i2c_client *client,
	...
	pr_err("bq2597x_charger_probe------------resume dump\n");
...
*/
	...
	oplus_warp_init_cp(&oplus_rkbq2597x_ops);
